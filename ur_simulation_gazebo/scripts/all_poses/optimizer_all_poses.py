...
def parse_args():
    ...
    ap.add_argument("--weights-list", nargs="+", default=["ur_sensor_sim/tmp/weighted_poses_semi_zeros/*.npy"], help="One or more .npy paths or globs (one per pose).")
    ...
    ap.add_argument("--export-json", type=str, default="ur_sensor_sim/tmp/result_big_sensor_list_semi.json",
