...
def main():
    ...
    sel = [2714,
      ...
      3183,
      3184,
      3185]#range(2658, len(cands)) #[263, 275, 647, 1471, 1507, 1646, 1921, 1938, 1945, 2016]
  # [266, 275, 640, 647, 668, 876, 1440, 1456, 1471, 1921, 1933, 2022, 2629, 2658, 2659, 2660, 2661, 2662, 2663, 2664]
